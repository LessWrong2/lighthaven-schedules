...
export const locColRowVars = [
  "grid-rows-[repeat(1,28px)]",
  "grid-rows-[repeat(2,28px)]",
  "grid-rows-[repeat(3,28px)]",
  "grid-rows-[repeat(4,28px)]",
  "grid-rows-[repeat(5,28px)]",
  "grid-rows-[repeat(6,28px)]",
  "grid-rows-[repeat(7,28px)]",
  "grid-rows-[repeat(8,28px)]",
  "grid-rows-[repeat(9,28px)]",
  "grid-rows-[repeat(10,28px)]",
  "grid-rows-[repeat(11,28px)]",
  "grid-rows-[repeat(12,28px)]",
  "grid-rows-[repeat(13,28px)]",
  "grid-rows-[repeat(14,28px)]",
  "grid-rows-[repeat(15,28px)]",
  "grid-rows-[repeat(16,28px)]",
  "grid-rows-[repeat(17,28px)]",
  "grid-rows-[repeat(18,28px)]",
  "grid-rows-[repeat(19,28px)]",
  "grid-rows-[repeat(20,28px)]",
  "grid-rows-[repeat(21,28px)]",
  "grid-rows-[repeat(22,28px)]",
  "grid-rows-[repeat(23,28px)]",
  "grid-rows-[repeat(24,28px)]",
  "grid-rows-[repeat(25,28px)]",
  "grid-rows-[repeat(26,28px)]",
  "grid-rows-[repeat(27,28px)]",
  "grid-rows-[repeat(28,28px)]",
  "grid-rows-[repeat(29,28px)]",
  "grid-rows-[repeat(30,28px)]",
  "grid-rows-[repeat(31,28px)]",
  "grid-rows-[repeat(32,28px)]",
  "grid-rows-[repeat(33,28px)]",
  "grid-rows-[repeat(34,28px)]",
  "grid-rows-[repeat(35,28px)]",
  "grid-rows-[repeat(36,28px)]",
  "grid-rows-[repeat(37,28px)]",
  "grid-rows-[repeat(38,28px)]",
  "grid-rows-[repeat(39,28px)]",
  "grid-rows-[repeat(40,28px)]",
  "grid-rows-[repeat(41,28px)]",
  "grid-rows-[repeat(42,28px)]",
  "grid-rows-[repeat(43,28px)]",
  "grid-rows-[repeat(44,28px)]",
  "grid-rows-[repeat(45,28px)]",
  "grid-rows-[repeat(46,28px)]",
  "grid-rows-[repeat(47,28px)]",
  "grid-rows-[repeat(48,28px)]",
  "grid-rows-[repeat(49,28px)]",
  "grid-rows-[repeat(50,28px)]",
  "grid-rows-[repeat(51,28px)]",
  "grid-rows-[repeat(52,28px)]",
  "grid-rows-[repeat(53,28px)]",
  "grid-rows-[repeat(54,28px)]",
  "grid-rows-[repeat(55,28px)]",
  "grid-rows-[repeat(56,28px)]",
  "grid-rows-[repeat(57,28px)]",
  "grid-rows-[repeat(58,28px)]",
  "grid-rows-[repeat(59,28px)]",
  "grid-rows-[repeat(60,28px)]",
  "grid-rows-[repeat(61,28px)]",
  "grid-rows-[repeat(62,28px)]",
  "grid-rows-[repeat(63,28px)]",
  "grid-rows-[repeat(64,28px)]",
  "grid-rows-[repeat(65,28px)]",
  "grid-rows-[repeat(66,28px)]",
  "grid-rows-[repeat(67,28px)]",
  "grid-rows-[repeat(68,28px)]",
  "grid-rows-[repeat(69,28px)]",
  "grid-rows-[repeat(70,28px)]",
  "grid-rows-[repeat(71,28px)]",
  "grid-rows-[repeat(72,28px)]",
  "grid-rows-[repeat(73,28px)]",
  "grid-rows-[repeat(74,28px)]",
  "grid-rows-[repeat(75,28px)]",
  "grid-rows-[repeat(76,28px)]",
  "grid-rows-[repeat(77,28px)]",
  "grid-rows-[repeat(78,28px)]",
  "grid-rows-[repeat(79,28px)]",
  "grid-rows-[repeat(80,28px)]",
  "grid-rows-[repeat(81,28px)]",
  "grid-rows-[repeat(82,28px)]"
];
