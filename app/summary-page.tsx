  ...
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mt-3 prose max-w-none" dangerouslySetInnerHTML={{ __html: CONSTS.DESCRIPTION }}></div>
            ...
            <div key={event.Name}>
              ...
              <div className="flex text-gray-500 text-xs mt-1 gap-5 font-medium">
                <span className="flex gap-1 items-center">
                  ...
                  <span>
                    {DateTime.fromISO(`${event.Start}T12:00:00.000`, { zone: 'America/Los_Angeles' })
                      .toFormat('LLL d')}
                    {" - "}
                    {DateTime.fromISO(`${event.End}T12:00:00.000`, { zone: 'America/Los_Angeles' })
                      .toFormat('LLL d')}
                  </span>
                </span>
                <a
